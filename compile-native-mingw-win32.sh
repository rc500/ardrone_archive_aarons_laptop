...
toolchain_file=${this_dir}/native/mingw-toolchain.cmake
opencv_build_dir=${this_dir}/native/win32-third-party/opencv/build/
...
pushd "${build_dir}"
cmake "-DCMAKE_TOOLCHAIN_FILE=${toolchain_file}" ../../native -DINSTALL_DOC=OFF \
  "-DCMAKE_PREFIX_PATH=${opencv_build_dir}" \
