#Preliminary tests to enable the drone to ping-pong between targets
...
##                            cv.PolyLine(im,[polygon], True, (0,0,255),2, cv.CV_AA, 0)
                ...
                if found_box:
                  ...
                  if area/float(sqr[2]*sqr[3])>0.89:
                    found_box=False
                  else:  
                    #move towards box
                    ...
                    #yaw right until a square is found
